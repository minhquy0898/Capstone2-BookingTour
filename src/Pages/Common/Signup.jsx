...
function Signup({ navigate, dispatch }) {
  ...
  return (
    <div className="w-full my-0 mx-auto">
      <div className="w-full min-h-screen flex flex-wrap justify-center items-center p-[15px] bg-orange-400">
        <div className="w-[960px] items-center bg-orange-200 rounded-lg overflow-hidden flex flex-wrap justify-between pt-[100px] pr-[130px] pb-[70px] pl-[95px]">
          ...
          <form className="w-[294px] pt-[20px]">
            <div className="flex justify-around ">
              <div className=" bg-orange-100 w-full py-2 rounded-tl-md rounded-bl-md cursor-pointer">
                <span className="font-bold    uppercase text-[20px] text-gray-800 leading-6 text-center w-full block pb-54">
                  Đăng nhập
                </span>
              </div>
              <div className="bg-orange-300 w-full py-2 rounded-tr-md rounded-br-md cursor-pointer">
                <span className="font-bold uppercase text-[20px]  text-gray-800 leading-6 text-center w-full block pb-54">
                  Đăng ký
                </span>
              </div>
